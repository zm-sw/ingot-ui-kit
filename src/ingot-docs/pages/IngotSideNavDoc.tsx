...
export const IngotSideNavDoc: IngotDocPage = {
  ...
  avoidWhen: {
    cs: [
      <>
        ...
        <IngotCode>IngotList</IngotCode> s{" "}
        <IngotCode>variant=&quot;plain&quot;</IngotCode>.
      </>,
      <>
        Menu má vlastní chování navíc: skládání skupin, ikony, přetečení do „další".
        Tohle primitivum je záměrně holé; složitější menu ať si drží obrazovka, dokud se
        pro ně nenajde druhý žadatel.
      </>,
      <>
        Položka spouští akci, ne navigaci. Odkaz, který nikam nevede, je tlačítko —{" "}
    ...
    en: [
      <>
        ...
        <IngotCode>IngotList</IngotCode> with{" "}
        <IngotCode>variant=&quot;plain&quot;</IngotCode>.
      </>,
      <>
        The menu needs extra behaviour: collapsible groups, icons, overflow into a
        "more" control. This primitive is deliberately bare; a richer menu should stay
        with the screen until a second caller asks for it.
      </>,
      <>
        The item triggers an action, not navigation. A link that goes nowhere is a
        button — <IngotCode>Button</IngotCode>.
      </>,
    ],
  },
  props: [
      ...
      note: {
        ...
        en: (
          <>
            ...
            address — the primitive knows no router and must not pull one into the
            bundle.
          </>
        ),
      },
  ...
  a11y: {
    cs: [
      <>
        <IngotCode>label</IngotCode> je povinný schválně. Na stránce s víc navigacemi je{" "}
        <IngotCode>aria-label</IngotCode> to jediné, čím je odečítač rozezná — jinak
        uživatel slyší „navigace" dvakrát a neví, která je která.
      </>,
      <>
        Aktivní položka nese <IngotCode>aria-current=&quot;page&quot;</IngotCode>, ne
        jen jinou barvu. Zvýraznění barvou je informace, kterou odečítač nevidí.
      </>,
      <>
        Odkaz je <IngotCode>&lt;a href&gt;</IngotCode>, ne{" "}
        <IngotCode>&lt;div onClick&gt;</IngotCode>. Klávesnice, prostřední tlačítko myši
        i „otevřít v novém panelu" pak fungují samy a nikdo je nemusí dodělávat.
      </>,
    ],
    en: [
      <>
        ...
        apart — otherwise the user hears "navigation" twice and cannot tell which is
        which.
      </>,
      <>
        The active item carries <IngotCode>aria-current=&quot;page&quot;</IngotCode>,
        not just a different colour. Colour is information a screen reader cannot see.
      </>,
      <>
