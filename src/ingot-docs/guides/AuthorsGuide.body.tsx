...
const body: IngotGuideBody = {
  "nove-primitivum": {
    cs: <AddingPrimitive lang="cs" />,
    en: <AddingPrimitive lang="en" />,
  },
  "api-pravidla": { cs: <ApiRules lang="cs" />, en: <ApiRules lang="en" /> },
  "slovnik-props": { cs: <Vocabulary lang="cs" />, en: <Vocabulary lang="en" /> },
  "zivotni-cyklus": { cs: <Lifecycle lang="cs" />, en: <Lifecycle lang="en" /> },
  udrzba: { cs: <Maintenance lang="cs" />, en: <Maintenance lang="en" /> },
};
