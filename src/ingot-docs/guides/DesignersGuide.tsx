 ...
 * by itself.
 */
const NAMING_EXAMPLES: readonly IngotDocPage[] = [
  ButtonDoc,
  IngotEyebrowDoc,
  IngotTableDoc,
];
...
function Naming({ lang }: { lang: DocLang }): JSX.Element {
  const cs = lang === "cs";
  const columns: readonly IngotColumn<IngotDocPage>[] = [
    {
      key: "figma",
      header: cs ? "Ve Figmě" : "In Figma",
      cell: (row) => <IngotCode>{row.tag}</IngotCode>,
    },
    {
      key: "code",
...
export const DesignersGuide: IngotGuidePage = {
  slug: "pro-designery",
  group: "system",
  ...
  sections: [
    {
      ...
      body: { cs: <SourcesOfTruth lang="cs" />, en: <SourcesOfTruth lang="en" /> },
    },
    {
      id: "pojmenovani",
      title: { cs: "Pojmenování", en: "Naming" },
      body: { cs: <Naming lang="cs" />, en: <Naming lang="en" /> },
    },
    {
      id: "soubory",
      title: { cs: "Ke stažení", en: "Files" },
      body: { cs: <Files lang="cs" />, en: <Files lang="en" /> },
    },
    {
      id: "stav-a-verze",
      title: { cs: "Stav a verze", en: "Status and version" },
      body: { cs: <Badges lang="cs" />, en: <Badges lang="en" /> },
    },
    {
      id: "rozpor",
      title: { cs: "Když se to rozejde", en: "When they disagree" },
      body: { cs: <Mismatch lang="cs" />, en: <Mismatch lang="en" /> },
    },
  ],
};
