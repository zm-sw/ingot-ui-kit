...
const body: IngotGuideBody = {
    ...
    cs: (
      <div className="space-y-3 text-sm text-ink-2">
        ...
        <IngotList
          items={[
            <>
              <IngotCode>--accent</IngotCode> — samotná barva. Akce, vyplněné tlačítko,
              ikona, focusový obrys; je to i barva textu, takže musí být čitelná na
              plochách.
            </>,
            <>
              <IngotCode>--accent-ink</IngotCode> — tmavší stupeň akcentu. Hover akcí a
              barva odkazů.
            </>,
            <>
              <IngotCode>--accent-bg</IngotCode> — tint pod vybraným řádkem, odznakem a
              calloutem. Nikdy ne text.
            </>,
            <>
              <IngotCode>--accent-border</IngotCode> — linka akcentu, obrys toho tintu.
              Dekorativní, nenese informaci sama o sobě.
            </>,
          ]}
        />
        <p>
          Obrazovka sáhne po proměnné, ne po hodnotě. Tím se rodina i motiv dají vyměnit
          bez toho, aby se do obrazovek sahalo.
        </p>
      </div>
    ),
    en: (
      <div className="space-y-3 text-sm text-ink-2">
        ...
        <IngotList
          items={[
            ...
            <>
              <IngotCode>--accent-ink</IngotCode> — the darker step of the accent. Hover
              on actions, and the colour of links.
            </>,
            <>
            ...
            <>
              <IngotCode>--accent-border</IngotCode> — the accent line, the outline of
              that tint. Decorative; it carries no information on its own.
            </>,
          ]}
        />
        <p>
          A screen reaches for the variable, never the value. That is what makes both
          the family and the theme swappable without touching screens.
        </p>
      </div>
    ),
  },
  ...
  motion: { cs: <Motion lang="cs" />, en: <Motion lang="en" /> },
};
